  ...
  <div class="row">
    <div class="col-12">
      <div class="card border-info bg-light h-100 p-4 border-top-3">
        ...
        <p class="fs-6">
         The Orthopedics & Trauma Medicine program at Siloam Medical, Technical and Commercial Training College is designed to equip students with the essential knowledge and hands-on skills required to manage musculoskeletal injuries and disorders. The program covers anatomy and physiology of bones and joints, fracture management, casting and splinting techniques, wound care, and rehabilitation protocols.
      </div>
    </div>
  </div>
</div>
